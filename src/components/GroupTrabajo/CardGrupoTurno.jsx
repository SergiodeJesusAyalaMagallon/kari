...
const CardGrupoTurno = ({Titulo,Content,Edo,Color}) => {
    return(
        <div className="grid bg-onPrimary w-10/12 lg:w-5/12 m-auto rounded-2xl" id={Color}>
            <div className="bg-primary700 text-primary200 grid grid-cols-12 rounded-t-2xl">
                <div className="text-xl font-Sans font-extrabold my-4 ml-6 lg:-ml-40 col-span-9 text-center">{Titulo}</div>
